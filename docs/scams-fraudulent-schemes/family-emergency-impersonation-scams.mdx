...
<figure style={{ margin: '32px 0', textAlign: 'center' }}>
  <img 
    src="/img/scams-fraudulent-schemes/family-emergency-impersonation-scams/family-emergency-visual.webp"
...
<iframe
  id="emergency-iframe"
  src="/simulations/scams-fraudulent-schemes/family-emergency-impersonation-scams/family_emergency_simulator.html"
  width="100%"
