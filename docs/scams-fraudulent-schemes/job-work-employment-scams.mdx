  ...
  <div className="col col--6">
    <div className="glass-panel" style={{ padding: '24px', borderRadius: '16px', height: '100%', borderLeft: '4px solid #EF4444', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      <div>
        ...
        <h3 style={{ margin: '8px 0', fontSize: '1.25rem', fontWeight: '700' }}>₹276 Crore Lost to Job Fraud in 2024</h3>
        <p style={{ fontSize: '0.9rem', margin: '0 0 16px 0', opacity: '0.85', lineHeight: '1.5' }}><b>Job fraud drained over ₹276 crores</b> from Indian job seekers in 2024 — up from ₹198 crore the previous year. This money represents rent, education, medical treatment, and family survival for people at a vulnerable moment.</p>
      </div>
      <span style={{ fontSize: '0.75rem', opacity: '0.6', fontStyle: 'italic', marginTop: '12px' }}>Source: National Cyber Crime Reporting Portal (NCRP), 2024</span>
    </div>
  </div>
</div>
